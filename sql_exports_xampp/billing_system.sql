...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2021 at 01:50 PM
...
(8, 'pook', 'hdh', 'shshs', 53.00, 3, '2021-05-02 15:35:33'),
(9, '1', '1', '1', 1.00, 1, '2021-05-02 15:54:59');
...
--
ALTER TABLE `users`
  MODIFY `ID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111131;
COMMIT;
